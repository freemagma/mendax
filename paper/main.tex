...
The two opposing models were trained
...
A typical training session started with the first two initial epochs,
...
In an attempt to find a training session mathcing this quality
